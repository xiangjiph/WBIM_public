...
exp_name = 'WBIM20230305002_20230528';

im_root_folder = '/nfs/birdstore/Vessel/WBIM/Acquisition/TestSample/WBIM20230305002_20230528/00001/Ablation/Ablation_test';
abl_plane   = [nan, 0, 5, 10, 15, 20, 25, 30, 25, 20, 25, 15, 20, 25, 30, 35, 40];
abl_fluence = [nan, 6, 6,  6,  6,  6,  6, 10,  8,  8, 10, 10, 10, 10, 10, 10, 10];

vis_folder = fullfile(DataManager.fp_experiment(exp_group, exp_name), 'visualization', ...
    'single_plane_ablation_site_1');
%%
...
for i = 1 : num_tiff
    ...
    tmp_vis_im(:, :, 2) = max(tmp_vis_im(:, :, 2), tmp_im{3});        
